...
import com.groom.common.infrastructure.config.security.JwtAuthenticationFilter;
...
import com.groom.user.service.TestSecurityConfig;

@WebMvcTest(
    controllers = AddressControllerV1.class,
...
class AddressControllerV1Test {
    ...
    class GetAddressesTest {
        ...
        void getAddresses_Success() throws Exception {
            given(addressService.getAddresses(any()))
    ...
    class CreateAddressTest {
        ...
        void createAddress_Success() throws Exception {
            ...
            willDoNothing().given(addressService).createAddress(any(), any(ReqAddressDtoV1.class));

            mockMvc.perform(post("/api/v1/users/me/addresses")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(objectMapper.writeValueAsString(request)))
                .andDo(print())
                // 컨트롤러가 200/201 둘 중 무엇을 리턴하든 통과
        ...
        void createAddress_MissingRequired_BadRequest() throws Exception {
            ReqAddressDtoV1 request = new ReqAddressDtoV1();
            request.setZipCode("12345"); // 나머지 누락
    ...
    class UpdateAddressTest {
        ...
        void updateAddress_Success() throws Exception {
            ...
            willDoNothing().given(addressService).updateAddress(any(), any(), any(ReqAddressDtoV1.class));
    ...
    class SetDefaultAddressTest {
        ...
        void setDefaultAddress_Success() throws Exception {
            willDoNothing().given(addressService).setDefaultAddress(any(), any());
